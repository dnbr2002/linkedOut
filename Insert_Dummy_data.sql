...
Insert Into comment (postid, comment, commenterid) values (1, 'no Im the man!!', 2);
Insert Into comment (postid, comment, commenterid) values (2, 'you said it', 4);
Insert Into comment (postid, comment, commenterid) values (3, 'Comment on post id 3', 1);
Insert Into comment (postid, comment, commenterid) values (4, 'Comment on post id 4', 1);
Insert Into comment (postid, comment, commenterid) values (1, 'Comment on post id 1 Again', 1);
Insert Into comment (postid, comment, commenterid) values (1, 'Comment on post id 1 Yet Again', 2);
